...
//   getFecha(idRuta: number): string {
//     const ruta = this.ruta.find(r => r.idRuta === idRuta);
//     return ruta ? ruta.fechaServicio : 'Desconocido';
//   }
...
//     return unidad ? unidad.placaUnidad : 'Desconocido';
//   }
