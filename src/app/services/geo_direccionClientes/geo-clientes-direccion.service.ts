...
export class GeoClientesDireccionService {
  ...
  getClientesDireccion(): Observable<GeoClientesDireccion[]> {
    return this.http
      .get<GeoClientesDireccion[]>(this.API_URI)
      .pipe(catchError(this.handleError));
  }

  getClienteDireccionById(id: number): Observable<GeoClientesDireccion> {
    return this.http
      .get<GeoClientesDireccion>(`${this.API_URI}/${id}`)
      .pipe(catchError(this.handleError));
  }

  createClienteDireccion(
    cliente: GeoClientesDireccion
  ): Observable<GeoClientesDireccion> {
    return this.http
      .post<GeoClientesDireccion>(this.API_URI, cliente)
      .pipe(catchError(this.handleError));
  }
  ...
  updateClienteDireccion(
    ...
    return this.http
      .put<GeoClientesDireccion>(`${this.API_URI}/${id}`, cliente)
      .pipe(catchError(this.handleError));
  }

  deleteClienteDireccion(id: number): Observable<void> {
    return this.http
      .delete<void>(`${this.API_URI}/${id}`)
      .pipe(catchError(this.handleError));
  }
